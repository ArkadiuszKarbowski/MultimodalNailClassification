...
from src.utils.prepare_dataset_utils.dataset_stats import ImageDataset, calculate_dataset_statistics
...
def test_image_resizing(mocker, temp_dir):
    ...
    mocker.patch("src.utils.prepare_dataset_utils.dataset_stats.read_image", return_value=img)
