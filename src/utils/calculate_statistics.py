...
if __name__ == "__main__":
    ...
    parser.add_argument('--output', type=str, default='datasets/dataset/dataset_stats.json', help='Output JSON file path')
    parser.add_argument('--batch_size', type=int, default=32, help='Batch size for image loading')
