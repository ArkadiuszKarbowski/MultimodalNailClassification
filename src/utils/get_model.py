...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Load model architecture from a Python file"
    )
    parser.add_argument(
        "file_path", help="Path to the Python file containing the model architecture"
    )
    parser.add_argument(
        "--model_name", help="Name of the model class/function in the file"
    )
    parser.add_argument(
        "--model_args", help="JSON string of arguments to pass to the model constructor"
    )
    parser.add_argument(
        "--device", help="Device to move the model to (e.g., 'cuda', 'cpu')"
    )
