...
def split_dataset(dataset_dir, val_ratio=0.1, test_ratio=0.1, modality=1, random_state=2137, verbose=True):
    '''
...
if __name__ == "__main__":
    train_files, val_files, test_files = split_dataset('datasets/dataset', verbose=True, modality=4)
    print('\nExample samples:')
